...
CREATE TABLE Serie(
    ...
    codProva NUMBER NOT NULL,
    etapa NVARCHAR2(13) NOT NULL,
    data NVARCHAR2(10) NOT NULL,
...
CREATE TABLE Atleta (
    ...
    nacionalidade NVARCHAR2(10) NOT NULL    
);
